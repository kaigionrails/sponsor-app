...
{
  parameterStoreArn(name):: std.format('arn:aws:ssm:us-west-2:861452569180:parameter/sponsor-app-staging/%s', name),

  family: 'sponsor-app-staging-worker',
  ...
  containerDefinitions: [
    {
      ...
      environment: [
        ...
        },
        {
          ...
          value: 'sponsorships-staging@kaigionrails.org',
        },
        {
      ...
      secrets: [
        ...
        },
        {
          ...
          valueFrom: $.parameterStoreArn('S3_FILES_PREFIX'),
        },
        {
      ...
      logConfiguration: {
        logDriver: 'awslogs',
        options: {
          'awslogs-group': '/ecs/sponsor-app-staging-worker',
